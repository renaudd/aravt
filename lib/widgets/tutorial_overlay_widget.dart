 ...
 Widget build(BuildContext context) {
   return Consumer2<TutorialService, GameState>(
     builder: (context, tutorial, gameState, child) {
       ...
       final captain = captainId != null ? gameState.findSoldierById(captainId) : null;
       ...
       final isAnnoyed = tutorial.dismissalCount > 0;
         ...
         child: Material(
           ...
           child: Container(
             ...
             decoration: BoxDecoration(
               ...
               border: Border.all(
                   color: isAnnoyed ? Colors.red.shade800 : const Color(0xFFE0D5C1),
                   width: 2),
                       ...
                       Row(
                         ...
                         children: [
                           TextButton(
                             ...
                             child: Text("Dismiss",
                                 style:
                                     GoogleFonts.cinzel(color: Colors.white38)),
                           ),
