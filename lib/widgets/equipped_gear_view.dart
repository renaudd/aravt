   ...
   return Container(
     ...
     child: Stack(
       ...
       children: [
         ...
         // --- SLOTS ---
         // Center Column
         _buildSlot(context, EquipmentSlot.helmet, top: 8, left: centerOfSilhouette - 30),
         _buildSlot(context, EquipmentSlot.necklace, top: 75, left: centerOfSilhouette - 16),
         _buildSlot(context, EquipmentSlot.armor, top: 110, left: centerOfSilhouette - 30),
         _buildSlot(context, EquipmentSlot.undergarments, top: 200, left: centerOfSilhouette - 30),
         _buildSlot(context, EquipmentSlot.boots, top: 360, left: centerOfSilhouette - 24),
 ...
 Widget _buildSlot(BuildContext context, EquipmentSlot slot,
   ...
   Widget slotWidget = Container(
     ...
     decoration: BoxDecoration(
       ...
       border: Border.all(
           color: item != null ? Colors.amber.withOpacity(0.6) : Colors.white24),
